        ...
        <div className="space-y-12 pb-16">
            <section className="bg-gradient-to-b from-white to-bg-light py-12">
                <div className="mx-auto max-w-6xl px-4">
                    <h1 className="text-3xl font-bold text-brand-primary">{t.transport.title}</h1>
                    <p className="mt-4 text-gray-700">{t.transport.intro}</p>
                </div>
            </section>

            <section className="mx-auto max-w-6xl px-4">
                <h2 className="text-2xl font-semibold text-brand-primary">{t.transport.servicesTitle}</h2>
            ...
            <CTASection
                ...
                primary={{ label: t.transport.primary, href: getRoute('contact', locale) }}
                secondary={{ label: t.transport.secondary, href: `https://wa.me/${company.phone.replace(/[^0-9]/g, '')}` }}
            />
        </div>
    );
}
