    ...
    <div className="space-y-12 pb-16">
      ...
      <section className="bg-gradient-to-b from-white to-bg-light py-12">
        <div className="mx-auto max-w-6xl px-4">
          <h1 className="text-3xl font-bold text-brand-primary">{t.about.title}</h1>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-4 lg:grid-cols-3">
        <div className="rounded-2xl bg-white p-8 shadow-soft lg:col-span-2">
          <h2 className="text-2xl font-semibold text-brand-primary">{t.about.storyTitle}</h2>
          <p className="mt-3 text-gray-700">{t.about.story}</p>
          <h3 className="mt-6 text-xl font-semibold text-brand-primary">{t.about.secondTitle}</h3>
          <p className="mt-3 text-gray-700">{t.about.second}</p>
          <h3 className="mt-6 text-xl font-semibold text-brand-primary">{t.about.valuesTitle}</h3>
        ...
        <div className="rounded-2xl bg-bg-light p-8">
          <h3 className="text-xl font-semibold text-brand-primary">{t.about.whyTitle}</h3>
      ...
      <CTASection
        ...
        secondary={{ label: t.about.secondary, href: getRoute('vehicles', locale) }}
      />
    </div>
  );
}
