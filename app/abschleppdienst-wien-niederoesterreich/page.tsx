...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		...
		openGraph: {
			...
			type: "website",
			images: [
				`${siteUrl}/images/abschleppdienst-pablo-sollenau-a2-einsatz.webp`,
			],
		},
		twitter: {
		...
		"@graph": [
			{
				...
				image:
					"https://pablo-auto.at/assets/logo-pablo-autohandel-abschleppdienst.png",
		...
		<div className="pb-24">
			...
			<section className="py-16 bg-white" aria-labelledby="steps-heading">
				<div className="mx-auto max-w-6xl px-4">
					<h2
						id="steps-heading"
						className="text-center text-2xl font-bold text-brand-primary md:text-3xl mb-12"
					>
						{t.towing.stepsTitle}
					</h2>
					<div className="grid gap-8 md:grid-cols-3">
						{t.towing.steps.map((step, index) => (
							<div
								key={index}
								className="rounded-xl border border-gray-100 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:shadow-lg"
							>
								<div className="mb-4 text-4xl font-black text-gray-200">
									0{index + 1}
								</div>
			...
			<section className="py-16 bg-gray-50" aria-labelledby="services-heading">
				<div className="mx-auto max-w-6xl px-4">
					<h2
						id="services-heading"
						className="text-3xl font-bold text-brand-primary mb-12"
					>
					...
					<div className="grid gap-12 lg:grid-cols-2">
						<div className="grid gap-6">
							{t.towing.services.map((service, index) => (
								<article
									key={index}
									className="flex gap-4 rounded-xl bg-white p-6 shadow-sm hover:shadow-md transition-shadow"
								>
			...
			<section className="py-16 bg-white">
				<div className="mx-auto max-w-6xl px-4">
					<BlogTeaserBox
						post={
							getAllPosts(locale).find((p) => p.cluster === "roadside") ||
							getAllPosts(locale)[0]
						}
						categoryLabel={
							locale === "de"
								? "Ratgeber: Pannenhilfe"
								: locale === "pl"
									? "Poradnik: Pomoc Drogowa"
									: "Guide: Roadside"
						}
						locale={locale}
					/>
			...
			<section className="py-16 bg-gray-50" aria-labelledby="faq-heading">
				<div className="mx-auto max-w-4xl px-4">
					<h2
						id="faq-heading"
						className="text-center text-3xl font-bold text-brand-primary mb-12"
					>
						{t.towing.faq.title}
					</h2>
