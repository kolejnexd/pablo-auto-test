...
export default function VehicleCard({ vehicle, locale, cta }: VehicleCardProps) {
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-sm text-gray-600 mb-6">
            ...
            <div className="flex items-center gap-2 col-span-2">
              <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 flex items-end justify-between">
            <div>
              {vehicle.priceStatus === 'Auf Anfrage' || vehicle.priceGross === 0 ? (
                <span className="text-xl font-bold text-gray-900">
                  {locale === 'pl' ? 'Na zapytanie' : locale === 'en' ? 'On Request' : 'Auf Anfrage'}
                </span>
              ) : (
                <>
                  ...
                  {(vehicle.priceNetto ?? 0) > 0 && vehicle.priceGross !== vehicle.priceNetto && (
