	...
	return (
		<div className="min-h-screen pb-16">
			...
			<section className="relative overflow-hidden bg-brand-primary py-20 text-white lg:py-28">
				<div className="absolute inset-0 bg-[url('/abschleppdienst-muster.svg')] opacity-10" />
				<div className="absolute -left-10 -top-10 h-64 w-64 rounded-full bg-blue-500 blur-3xl opacity-20" />
				<div className="absolute -right-10 bottom-0 h-64 w-64 rounded-full bg-purple-500 blur-3xl opacity-20" />
						...
						<div className="space-y-8 lg:col-span-5">
							...
							<div className="grid sm:grid-cols-2 gap-4 lg:grid-cols-1">
								{contactDetails.map((item, idx) => (
									...
									>
										<div
											className={`mr-4 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl ${item.bg} ${item.color}`}
										>
