  ...
  return (
    <footer className="mt-16 border-t bg-bg-light/60">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-4 py-10 sm:grid-cols-2 lg:grid-cols-5">
        <div>
          <h3 className="text-lg font-semibold text-brand-primary">{t.footer.contact}</h3>
          <p className="mt-2 text-sm text-gray-700">
            {company.name}
            <br />
            {company.address}
            <br />
            Telefon: <a href={`tel:${company.phone.replace(/[^0-9+]/g, '')}`}>{company.phone}</a>
            <br />
            E-Mail: <a href={`mailto:${company.email}`}>{company.email}</a>
          </p>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-brand-primary">{t.footer.services}</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-brand-primary">{t.footer.about}</h3>
          <ul className="mt-2 space-y-2 text-sm text-gray-700">
        ...
        <div>
          <h3 className="text-lg font-semibold text-brand-primary">{t.footer.legal}</h3>
          <ul className="mt-2 space-y-2 text-sm text-gray-700">
        ...
        <div>
          <h3 className="text-lg font-semibold text-brand-primary">{t.footer.useful}</h3>
          <ul className="mt-2 space-y-2 text-sm text-gray-700">
      ...
      <div className="border-t bg-white py-4 text-xs text-gray-500">
        <div className="relative mx-auto flex w-full flex-col items-center gap-2 px-4 sm:block">
          <p className="text-center">© {new Date().getFullYear()} {company.name}. {t.footer.copyright}</p>
