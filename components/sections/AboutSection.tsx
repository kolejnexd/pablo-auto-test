                ...
                <div className="mb-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                        {content.benefits.map((benefit, idx) => (
                            <div key={idx} className="flex flex-col md:flex-row gap-6 bg-white p-6 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                                <div className="shrink-0 flex items-center justify-center w-16 h-16 bg-red-50 rounded-full">
                                    {benefit.icon === 'Clock' ? <ClockIcon /> : <ShieldCheckIcon />}
                                </div>
