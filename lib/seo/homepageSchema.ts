export const getHomepageSchema = () => {
    return {
        ...
        "@type": ["AutomotiveBusiness", "AutoDealer", "AutoTowingService", "AutoRental"],
                    ...
                    "itemListElement": [
                        {
                            ...
                            "description": "Soforthilfe in 30 Minuten. Transport von PKW, Elektroautos (Tesla) und Motorrädern.",
                        ...
                        },
                        {
                            ...
                            "description": "Holowanie i pomoc drogowa dla Polaków w Austrii. Obsługa autostrad A2/S1."
                        }
                    ]
                },
                {
                    ...
                    "itemListElement": [
                        {
                            ...
                            "description": "Zertifizierte Fahrzeuge mit Gewährleistung, carLOG-Historie und Finanzierung.",
                            "itemOffered": { "@type": "Car", "name": "Gebrauchtwagenbestand" }
                        },
                        {
                            "@type": "Service",
                            "name": "Export Service & Autoankauf",
                            "description": "Skup aut za gotówkę i pomoc w eksporcie (Zollkennzeichen)."
                        }
                    ]
                },
                {
                    ...
                    "itemListElement": [
                        {
                            ...
                            "description": "Mietwagen ohne Kreditkarte, Unfallersatzwagen, 9-Sitzer Busse.",
                            "priceSpecification": {
                        ...
                        },
                        {
                            ...
                            "description": "Zarządzanie najmem dla właścicieli i mieszkania bez prowizji."
                        }
                    ]
                },
                {
                    ...
                    "itemListElement": [
                        {
                            ...
                            "description": "Privatumzüge ohne Stockwerkzuschlag, Montage und Verpackung.",
                            "serviceType": "Moving Service"
                        },
                        {
                            "@type": "Service",
                            "name": "Transport Polska-Austria",
                            "description": "Regularna linia transportowa, przewóz mebli i paczek."
                        }
                    ]
                }
            ]
