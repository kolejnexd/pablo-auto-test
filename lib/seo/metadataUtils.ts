...
import { type Locale, type RouteKey, getRoute } from "../routes";
import { seoConfig } from "../seoConfig";
import { company, languages } from "../siteConfig";
...
export function generatePageAlternates(
	...
	const canonical =
		currentLocale === "de" ? deUrl : currentLocale === "pl" ? plUrl : enUrl;
...
export function generateSeoMetadata({
	...
	return {
		...
		description:
			description ||
			seoConfig.home.description[locale as Locale] ||
			seoConfig.home.description.de,
