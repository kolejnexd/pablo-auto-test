...
import { type Locale, type RouteKey, getRoute, routes } from "./routes";
...
export function constructMetadata({
	...
	if (key) {
		...
		throw new Error(
			'constructMetadata requires either "key" or "canonicalUrl".',
		);
	}
	...
	return {
		title,
		description,
		metadataBase: new URL("https://pablo-auto.at"),
		alternates: {
			canonical,
