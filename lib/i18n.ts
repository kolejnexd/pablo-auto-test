...
import { getRoute, routes, RouteKey } from './routes';
...
export function detectLocaleFromPath(pathname: string, preferredLocale?: string | null): Locale {
...
function withLocalePrefix(path: string, locale: Locale): string {
  ...
  if (locale === 'de') return cleaned === '/pl' || cleaned === '/en' ? '/' : cleaned;
...
export function getLocaleHref(pathname: string, targetLocale: Locale, preferredLocale?: string | null): string {
...
const translations: Record<Locale, Translations> = {
  de: {
    common: {
      ...
      supporting: 'Schnelle Hilfe auf der A2, im Bezirk Wiener Neustadt-Land und direkt in Sollenau. Fahrzeuge, Abschleppdienst und Vermietung aus einer Hand.',
      whatsapp: 'WhatsApp',
    ...
    footer: {
      ...
      serviceLinks: [
        { href: getRoute('towing', 'de'), label: 'Abschleppdienst & Pannenhilfe' },
        { href: getRoute('carSales', 'de'), label: 'Gebrauchtwagenhandel & Ankauf' },
    ...
    home: {
      hero: {
        title: 'Pablo e.U. – Ihr Mobilitäts-Partner in Sollenau & Wien: Autohandel, Abschleppdienst & Transport',
        subtitle: 'Als zertifizierter Einzelunternehmer (e.U.) mit Basis in Sollenau direkt an der Südautobahn A2, garantieren wir eine Reaktionszeit von 30 Minuten bis ins Zentrum von Wien. Unser Spezialfahrzeug transportiert auch Elektroautos (Tesla) sicher. Alles aus einer Hand: Abschleppdienst, Autohandel und Vermietung.',
      ...
      protection: {
        ...
        intro: 'Pannen passieren unerwartet. Wir decken die S1 Wiener Außenring Schnellstraße und den Bezirk Baden ab. Von der Abfahrt Leobersdorf oder Wöllersdorf sind wir in Minuten vor Ort.',
        items: [
          { title: 'Abschleppdienst', description: 'Sicherer Transport für PKW, Transporter und Unfallwagen.' },
          { title: 'Pannenhilfe vor Ort', description: 'Starthilfe, Reifenwechsel oder Treibstoffmangel (Hilfe vor Ort).' },
          { title: 'Fahrzeugbergung', description: 'Professionelle Bergung nach Unfällen (auch aus Gräben).' },
          { title: 'Europaweiter Rückholdienst', description: 'Wir bringen Sie und Ihr Fahrzeug nach Hause.' }
        ]
      },
      trade: {
        title: 'Seriöser Autohandel & Autoankauf in Niederösterreich',
        intro: 'Jedes Fahrzeug wird mit gültigem §57a Pickerl und transparenter carLOG-Historie verkauft. Wir bieten Gewährleistung und faire Fixpreise. Ankauf auch von Unfallwagen.',
        items: [
          { title: 'Verkauf', description: 'Geprüfte Gebrauchtwagen (PKW, Nutzfahrzeuge), Transporter & Anhänger. Besichtigung in Sollenau (Industriestraße 1) jederzeit möglich (nach Terminvereinbarung).' },
          { title: 'Autoankauf (Sofort Bargeld)', description: 'Wir kaufen PKW aller Marken – auch ohne Pickerl, mit Motorschaden oder Unfallwagen. Schnelle Abwicklung und Barzahlung.' }
        ]
      },
      whyUs: {
        title: 'Warum Pablo e.U. Ihr bester Partner in Sollenau ist',
        items: [
          { title: 'Erreichbarkeit', description: 'Echter 24h Notdienst – bei uns geht immer jemand ans Telefon, auch an Feiertagen.' },
          { title: 'Mehrsprachig (DE/PL/EN)', description: 'Keine Missverständnisse bei Pannen. Ideal für internationale Transporteure auf der A2.' },
          { title: 'Alles aus einer Hand', description: 'Abschleppen, Ersatzwagen (Mietwagen) und Ankauf/Verkauf.' }
        ]
      },
      faq: {
        ...
        items: [
          {
            ...
            answer: 'Wir priorisieren Notfälle in Sollenau und entlang der A2. Rufen Sie uns direkt unter +43 664 1261735 an, um Wartezeit und Standort zu bestätigen.'
          },
          {
            question: 'Kaufen Sie auch Fahrzeuge mit Unfallschäden oder Motorschaden an?',
            answer: 'Ja, wir bewerten Unfallfahrzeuge, Fahrzeuge mit höherer Laufleistung oder ohne gültiges Pickerl und bieten faire Konditionen.'
          },
          {
            question: 'Kann ich den Abschleppdienst direkt vor Ort mit Karte bezahlen?',
            answer: 'Ja, wir akzeptieren Barzahlung sowie gängige Debit- und Kreditkarten, direkt nach dem Einsatz.'
          }
        ]
      },
      blog: {
        title: 'Aktuelles aus unserem Ratgeber',
        subtitle: 'Tipps, Tricks und Neuigkeiten rund um Auto, Panne und Verkehrssicherheit.',
        cta: 'Alle Artikel lesen'
      }
    },
    towing: {
      title: 'Abschleppdienst 24/7 Sollenau & Wiener Neustadt: Ihr Notruf-Partner',
      intro:
      ...
      steps: [
        { title: '1. Anruf', description: 'Wählen Sie sofort +43 664 1261735.' },
        {
          title: '2. Standort',
          description: 'Teilen Sie uns Ihren Standort via WhatsApp mit, damit wir Sie auf der A2 oder in den umliegenden Gemeinden sofort finden.'
        },
        {
          title: '3. Sicherung & Bergung',
          description: 'Wir sichern die Unfallstelle und transportieren Ihr Fahrzeug sicher ab.'
        }
      ],
      servicesTitle: 'Unsere 24/7 Einsatzbereiche: Mehr als nur Abschleppen',
      services: [
        { title: 'Pannendienst & Soforthilfe', description: 'Starthilfe, Reifenwechsel oder provisorische Maßnahmen direkt am Einsatzort – oft ist keine Abschleppung nötig.' },
        { title: 'Fahrzeugabschleppung & Bergung', description: 'Sicherer Abtransport für PKW, Transporter und Unfallwagen zu Ihrer Wunschwerkstatt oder unserem Standort in Sollenau.' },
        { title: 'Ersatzwagen & Mobilität', description: 'Damit Sie mobil bleiben: Wir stellen bei Verfügbarkeit direkt einen Ersatzwagen zur Verfügung.' }
      ],
      whyUs: {
        title: 'Warum Pablo e.U. die beste Wahl in Niederösterreich ist',
        items: [
          { title: '24/7 Verfügbarkeit', description: 'Wir sind 365 Tage im Jahr erreichbar – auch an Wochenenden und Feiertagen.' },
          { title: 'Zweisprachige Betreuung (DE/PL)', description: 'Wir bieten vollständige Beratung in Deutsch und Polnisch, ideal für lokale Kunden und die internationale Community.' },
          { title: 'Flexible Zahlung', description: 'Bezahlen Sie unkompliziert in bar oder per Karte direkt vor Ort nach dem Einsatz.' },
          { title: 'Lokale Expertise', description: 'Unser Standort in Sollenau ermöglicht schnellste Reaktionszeiten in Wr. Neustadt, Baden und Neunkirchen.' }
        ]
      },
      faq: {
        title: 'Häufig gestellte Fragen (FAQ)',
        items: [
          {
            ...
            answer: 'Wir priorisieren Notrufe auf der A2 und im Raum Wiener Neustadt. Durch unseren strategischen Standort in Sollenau sind wir bestrebt, innerhalb kürzester Zeit bei Ihnen zu sein.'
          },
          {
            question: 'Was kostet ein Abschleppdienst in der Nacht oder am Feiertag?',
            answer: 'Die Kosten hängen von der Einsatzzeit und der Distanz ab. Wir setzen auf faire und nachvollziehbare Konditionen. Rufen Sie uns für eine sofortige Preisindikation direkt an.'
          },
          {
            question: 'Kann ich direkt vor Ort mit Kreditkarte bezahlen?',
            answer: 'Ja, zur Vereinfachung akzeptieren wir Barzahlung sowie gängige Debit- und Kreditkarten direkt am Einsatzort.'
          }
        ]
      },
    ...
    autohandel: {
      title: 'Zertifizierte Gebrauchtwagen in Sollenau: Geprüfte Qualität günstiger als in Wien',
      intro:
      ...
      benefits: [
        { title: 'Schnelle Bewertung', description: 'Direkte Einschätzung und Angebot für Ihr Fahrzeug – auch bei Unfallschäden.' },
        { title: 'Faire Abwicklung', description: 'Transparente Konditionen, Auszahlung in Bar oder per Karte vor Ort.' },
        { title: 'Abholung möglich', description: 'Nach Absprache holen wir Ihr Fahrzeug ab – flexibel im Bezirk Wiener Neustadt-Land.' },
        { title: 'Mehrsprachige Beratung', description: 'Beratung auf Deutsch, Polnisch oder Englisch, je nach Wunsch.' }
      ],
      ctaTitle: 'Vereinbaren Sie einen Termin oder fordern Sie ein Ankaufangebot an',
      ctaDescription:
    ...
    rental: {
      title: 'Vermietung Pablo e.U.: Mietwagen & Immobilien-Management in Baden & Wien',
      intro:
      ...
      fleet: [
        { title: 'PKW', description: 'Verschiedene Klassen für den täglichen Bedarf – flexibel je nach Verfügbarkeit.' },
        { title: 'Leichte Nutzfahrzeuge', description: 'Transporter und Kastenwagen ideal für Umzüge, Handwerk oder kurzfristige Projekte.' },
        { title: 'Anhänger', description: 'Verschiedene Modelle für Transportaufgaben, nach Absprache verfügbar.' }
      ],
      ...
      ctaDescription: 'Kontaktieren Sie uns für eine Verfügbarkeitsanfrage und ein individuelles Mietangebot für PKW, Transporter oder Ersatzwagen.',
      primary: 'Verfügbarkeit anfragen',
      secondary: '24/7 Notruf'
    },
    transport: {
      title: 'Transport & Umzugsservice: Zuverlässig in Österreich & Europa (Polen-Linie)',
      intro: 'Professionelle Umzüge, Maschinentransporte und regelmäßige Linienverkehre zwischen Österreich und Polen. Wir bieten Pauschalpreise ohne versteckte Kosten.',
      servicesTitle: 'Unsere Transport-Lösungen',
      services: [
        { title: 'Umzug Wien & NÖ', description: 'Stressfreie Privatumzüge zum Fixpreis – keine Etagenzuschläge.' },
        { title: 'Polen-Linie', description: 'Regelmäßiger Transport von Möbeln, Paketen und Paletten (AT ↔ PL).' },
        { title: 'Maschinentransport', description: 'Spezialtransport für Baumaschinen und Landtechnik.' },
        { title: 'Logistik & Lager', description: 'Palettenversand B2B und Self-Storage Möglichkeiten in Sollenau.' }
      ],
      ctaTitle: 'Planen Sie Ihren Transport',
      ctaDescription: 'Holen Sie sich jetzt Ihr unverbindliches Angebot für Umzug oder Transport.',
    ...
    about: {
      ...
      ctaDescription: 'Wir freuen uns auf Ihre Anfrage – ob Notruf, Fahrzeugkauf oder Vermietung.',
    ...
    faq: {
      title: 'FAQ & Ratgeber',
      intro: 'Antworten auf die häufigsten Fragen zu Abschleppdienst, Autohandel und Vermietung.',
      items: [
        {
          question: 'Wie schnell kommt Ihr Abschleppdienst zur Unfallstelle?',
          answer: 'Wir priorisieren Einsätze in Sollenau, Wiener Neustadt und entlang der A2. Rufen Sie uns unter +43 664 1261735 an, um Details und Ankunftszeit abzustimmen.'
        },
        {
          question: 'Kaufen Sie auch Fahrzeuge mit Unfallschäden oder Motorschaden an?',
          answer: 'Ja, wir kaufen Fahrzeuge mit hoher Laufleistung, Unfallwagen oder Modelle ohne gültiges Pickerl. Transparente Bewertung und Auszahlung in Bar oder Karte.'
        },
        { question: 'Kann ich den Abschleppdienst mit Karte bezahlen?', answer: 'Ja, wir akzeptieren Barzahlung sowie gängige Debit- und Kreditkarten direkt nach dem Einsatz.' },
        { question: 'Bieten Sie Ersatzwagen an?', answer: 'Ja, wir stellen Ersatzwagen bereit, sofern verfügbar, häufig in Kombination mit unserem Abschleppdienst.' }
      ],
      blogTitle: 'Blog / Ratgeber (Placeholder)',
      blog: [
        {
          title: 'So sichern Sie den Unfallort richtig',
          description: 'Checkliste für die ersten Minuten nach einer Panne auf der A2 und im Bezirk Wiener Neustadt-Land.'
        },
        {
          title: 'Ankauf beschädigter Fahrzeuge',
          description: 'Wann lohnt sich der Verkauf eines Unfallwagens? Tipps zur fairen Bewertung.'
        }
      ]
    },
    vehicles: {
      title: 'Fahrzeuge – Gebrauchtwagen, Transporter & Anhänger',
      intro: 'Entdecken Sie unsere aktuellen Fahrzeuge. Alle Inserate sind nach Terminvereinbarung in Sollenau besichtigbar.'
    },
    vehicleDetail: {
    ...
    notFound: {
      title: 'Oje! (Ups!) Diese Seite existiert nicht mehr oder Ihr Traumwagen wurde bereits verkauft.',
      description:
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'Schnelle Hilfe auf der A2 nach einer Panne – innerhalb von Minuten vor Ort und gleich einen Ersatzwagen organisiert.',
          author: 'Kundin aus Wiener Neustadt'
        },
        { quote: 'Professioneller Ankauf unseres Transporters, faire Bewertung und sofortige Auszahlung vor Ort.', author: 'Lokaler Handwerksbetrieb' }
      ]
    },
    form: {
  ...
  pl: {
    ...
    home: {
      hero: {
        title: 'Laweta 24/7 Sollenau & Wiener Neustadt',
        subtitle: 'Jako licencowana firma jednoosobowa (e.U.) przy autostradzie A2 Südautobahn, gwarantujemy dojazd w 30 minut do Wiednia. Bezpiecznie holujemy także auta elektryczne (Tesla).',
        badges: '🇦🇹 🇵🇱 🇬🇧 Mówimy po niemiecku, polsku i angielsku',
        primaryCta: 'Tel. alarmowy: +43 664 1261735',
        secondaryCta: 'Zobacz samochody'
      },
      protection: {
        title: 'Twoja pomoc drogowa w powiecie Wiener Neustadt-Land i na A2',
        intro: 'Obsługujemy trasę S1 Wiener Außenring Schnellstraße oraz Bezirk Baden. Szybki dojazd do zjazdów Leobersdorf i Wöllersdorf.',
        items: [
          { title: 'Laweta', description: 'Bezpieczny transport aut osobowych, busów i powypadkowych.' },
          { title: 'Pomoc na miejscu', description: 'Starthilfe (odpalanie), wymiana koła lub dowóz paliwa.' },
          { title: 'Wyciąganie z rowu', description: 'Profesjonalne wyciąganie aut po wypadkach (także z rowów).' },
          { title: 'Holowanie do PL/AT', description: 'Odwieziemy Ciebie i Twoje auto do domu (usługa repatriacji).' }
        ]
      },
      trade: {
        title: 'Pewny autohandel i skup aut w Dolnej Austrii',
        intro: 'Każde auto sprzedajemy z ważnym przeglądem (§57a Pickerl) i historią carLOG. Oferujemy rękojmię (Gewährleistung). Skup aut za gotówkę.',
        items: [
          { title: 'Sprzedaż', description: 'Sprawdzone auta osobowe, busy i przyczepy. Oględziny w Sollenau (Industriestraße 1) możliwe o każdej porze (po umówieniu).' },
          { title: 'Skup aut (Gotówka)', description: 'Kupujemy auta wszystkich marek – także bez przeglądu, z uszkodzonym silnikiem lub po wypadku. Szybka gotówka.' }
        ]
      },
      whyUs: {
        title: 'Dlaczego Pablo e.U. to najlepszy partner w Sollenau',
        items: [
          { title: 'Dostępność', description: 'Prawdziwe 24h – zawsze odbieramy telefon, nawet w święta.' },
          { title: 'Wielojęzyczność (PL/DE/EN)', description: 'Brak nieporozumień przy awarii. Idealne dla transportu międzynarodowego na A2.' },
          { title: 'Wszystko w jednym', description: 'Holowanie, auto zastępcze (wynajem) oraz skup/sprzedaż aut.' }
        ]
      },
      faq: {
        ...
        items: [
          {
            ...
            answer: 'Priorytetowo obsługujemy A2 Südautobahn i Sollenau. Zadzwoń pod +43 664 1261735, aby potwierdzić czas dojazdu (zazwyczaj 30 min do Wiednia).'
          },
          {
            question: 'Czy skupujecie auta po wypadku?',
            answer: 'Tak, kupujemy samochody z wysokim przebiegiem, powypadkowe lub bez ważnego przeglądu – uczciwa wycena.'
          },
          {
            question: 'Czy zapłacę kartą?',
            answer: 'Tak, akceptujemy gotówkę oraz karty płatnicze zaraz po usłudze na miejscu.'
          }
        ]
      },
      blog: {
        title: 'Najnowsze wpisy z Poradnika',
        subtitle: 'Porady, wskazówki i aktualności dotyczące motoryzacji i pomocy drogowej.',
        cta: 'Zobacz wszystkie artykuły'
      }
    },
    towing: {
      title: 'Pomoc drogowa 24/7 Sollenau i Wiener Neustadt: Twój partner alarmowy',
      intro:
      ...
      steps: [
        { title: '1. Telefon', description: 'Zadzwoń natychmiast pod +43 664 1261735.' },
        { title: '2. Lokalizacja', description: 'Wyślij nam swoją lokalizację przez WhatsApp, abyśmy mogli szybko Cię znaleźć na A2 lub w okolicznych gminach.' },
        { title: '3. Zabezpieczenie', description: 'Zabezpieczamy miejsce zdarzenia i bezpiecznie transportujemy Twój pojazd.' }
      ],
      servicesTitle: 'Nasze obszary działań 24/7: więcej niż tylko holowanie',
      services: [
        { title: 'Pomoc drogowa na miejscu', description: 'Starthilfe (uruchomienie), wymiana koła lub zabezpieczenie miejsca zdarzenia. Oszczędność czasu i kosztów.' },
        { title: 'Holowanie i odzysk pojazdu', description: 'Bezpieczny transport samochodów osobowych, dostawczych i powypadkowych do warsztatu lub na nasz plac w Sollenau.' },
        { title: 'Auto zastępcze', description: 'Abyś mimo awarii pozostał mobilny, w zależności od dostępności zapewniamy bezpośrednio auto zastępcze.' }
      ],
      whyUs: {
        title: 'Dlaczego Pablo e.U. to najlepszy wybór w Dolnej Austrii',
        items: [
          { title: 'Dostępność 24/7', description: 'Jesteśmy dostępni 365 dni w roku – także w weekendy i święta.' },
          { title: 'Obsługa dwujęzyczna (DE/PL)', description: 'Pełna obsługa po niemiecku i polsku – idealna dla lokalnych klientów oraz społeczności na A2.' },
          { title: 'Elastyczna płatność', description: 'Wygodnie zapłacisz gotówką lub kartą bezpośrednio na miejscu po interwencji.' },
          { title: 'Lokalna wiedza', description: 'Nasza baza w Sollenau umożliwia najszybszy dojazd do Wiener Neustadt, Baden i Neunkirchen.' }
        ]
      },
      faq: {
        title: 'Najczęściej zadawane pytania (FAQ)',
        items: [
          {
            ...
            answer: 'Priorytetowo traktujemy zgłoszenia na A2 i w rejonie Wiener Neustadt. Dążymy do tego, aby być na miejscu w możliwie najkrótszym czasie.'
          },
          {
            question: 'Ile kosztuje holowanie w nocy lub w święto?',
            answer: 'Koszt zależy od pory interwencji i odległości. Stawiamy na uczciwe i przejrzyste warunki. Zadzwoń, aby uzyskać wycenę.'
          },
          {
            question: 'Czy mogę zapłacić na miejscu kartą kredytową?',
            answer: 'Tak, dla ułatwienia akceptujemy płatność gotówką oraz popularne karty debetowe i kredytowe bezpośrednio na miejscu.'
          }
        ]
      },
      ...
      ctaDescription: 'Lokalizacja: Industriestraße 1, 2601 Sollenau. Obsługa polskojęzyczna, holowanie, pomoc drogowa i auto zastępcze.',
      primary: 'Zadzwoń teraz',
      secondary: 'Napisz na WhatsApp'
    },
    transport: {
      title: 'Transport i Przeprowadzki: Polska-Austria i Europa',
      intro: 'Profesjonalne przeprowadzki, transport maszyn i regularne linie pomiędzy Austrią a Polską. Stałe ceny bez ukrytych kosztów.',
      servicesTitle: 'Nasze usługi transportowe',
      services: [
        { title: 'Przeprowadzki Wiedeń', description: 'Kompleksowe przeprowadzki w stałej cenie - bez dopłat za piętra.' },
        { title: 'Linia Polska-Austria', description: 'Regularny przewóz mebli, paczek i palet na trasie PL-AT.' },
        { title: 'Transport Maszyn', description: 'Specjalistyczny transport maszyn budowlanych i rolniczych.' },
        { title: 'Magazynowanie', description: 'Wysyłka paletowa B2B i magazynowanie w Sollenau.' }
      ],
      ctaTitle: 'Zaplanuj transport',
      ctaDescription: 'Uzyskaj darmową wycenę przeprowadzki lub transportu już teraz.',
    ...
    autohandel: {
      ...
      benefits: [
        { title: 'Szybka wycena', description: 'Natychmiastowa ocena auta, także po kolizji.' },
        { title: 'Uczciwe warunki', description: 'Transparentne zasady, wypłata gotówką lub kartą na miejscu.' },
        { title: 'Odbiór pojazdu', description: 'Po ustaleniach odbierzemy samochód w regionie Wiener Neustadt-Land.' },
        { title: 'Obsługa PL/DE', description: 'Doradzimy po polsku lub niemiecku.' }
      ],
      ctaTitle: 'Umów wizytę lub poproś o ofertę skupu',
      ctaDescription: 'Chętnie doradzimy po polsku lub niemiecku. Napisz lub zadzwoń, by sprzedać auto lub ustalić termin oględzin.',
    ...
    rental: {
      ...
      fleet: [
        { title: 'Samochody osobowe', description: 'Różne klasy na co dzień – zależnie od dostępności.' },
        { title: 'Lekkie pojazdy dostawcze', description: 'Busy i samochody dostawcze na przeprowadzki, projekty, usługi.' },
        { title: 'Przyczepy', description: 'Różne modele do zadań transportowych, po uzgodnieniu.' }
      ],
      ...
      ctaDescription: 'Skontaktuj się, aby sprawdzić dostępność i otrzymać ofertę wynajmu auta, busa lub pojazdu zastępczego.',
    ...
    about: {
      ...
      ctaTitle: 'Poznaj nas',
      ctaDescription: 'Czekamy na Twoje pytania – w sprawie lawety, zakupu auta czy wynajmu.',
    ...
    contact: {
      ...
      formDescription: 'Masz pytania o auto, skup lub potrzebujesz lawety? Napisz do nas!'
    },
    faq: {
      title: 'FAQ i porady',
      intro: 'Odpowiedzi na najczęstsze pytania dotyczące lawety, autohandlu i wynajmu.',
      items: [
        { question: 'Jak szybko dojedzie laweta?', answer: 'Priorytetowo obsługujemy Sollenau, Wiener Neustadt i A2. Zadzwoń pod +43 664 1261735, by ustalić czas.' },
        {
          question: 'Czy kupujecie auta po wypadku?',
          answer: 'Tak, pojazdy z dużym przebiegiem, powypadkowe lub bez przeglądu – uczciwa wycena, płatność gotówką lub kartą.'
        },
        { question: 'Czy zapłacę kartą?', answer: 'Tak, przyjmujemy gotówkę i karty zaraz po usłudze.' },
        { question: 'Czy macie auto zastępcze?', answer: 'Jeśli dostępne, udostępniamy auto zastępcze, często wraz z holowaniem.' }
      ],
      blogTitle: 'Blog / Ratgeber (Placeholder)',
      blog: [
        {
          title: 'Jak zabezpieczyć miejsce zdarzenia',
          description: 'Lista kontrolna na pierwsze minuty po awarii na A2 i w regionie Wiener Neustadt-Land.'
        },
        { title: 'Skup aut po szkodzie', description: 'Kiedy sprzedać auto po kolizji? Wskazówki do uczciwej wyceny.' }
      ]
    },
    vehicles: {
      title: 'Pojazdy – samochody, busy i przyczepy',
      intro: 'Sprawdź dostępne pojazdy. Wszystkie oględziny po umówieniu wizyty w Sollenau.'
    },
    vehicleDetail: {
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Błyskawiczna pomoc na A2 – byli na miejscu w kilka minut i załatwili auto zastępcze.', author: 'Klient z Wiener Neustadt' },
        { quote: 'Profesjonalny skup naszego busa, uczciwa wycena i wypłata od ręki.', author: 'Lokalna firma usługowa' }
      ]
    },
    form: {
  ...
  en: {
    ...
    home: {
      hero: {
        title: 'Pablo e.U. – Your Mobility Partner in Sollenau & Vienna: Car Sales, Towing & Transport',
        subtitle: 'As a certified sole proprietorship (e.U.) based in Sollenau right on the A2 South Autobahn, we guarantee a 30-minute response time to Vienna. We safely transport electric cars (Tesla) and provide rental cars without credit card.',
      ...
      protection: {
        ...
        intro: 'We cover the S1 Wiener Außenring Expressway and Baden District. Fast arrival at Leobersdorf and Wöllersdorf exits guaranteed.',
        items: [
          { title: 'Towing Service', description: 'Safe transport for cars, vans, and accident vehicles.' },
          { title: 'On-site Assistance', description: 'Jump start, tire change or fuel delivery (help on location).' },
          { title: 'Vehicle Recovery', description: 'Professional recovery after accidents (also from ditches).' },
          { title: 'European Repatriation', description: 'We bring you and your vehicle home.' }
        ]
      },
      trade: {
        title: 'Reputable Car Trading & Purchase in Lower Austria',
        intro: 'Looking for a reliable used car or want to sell your old vehicle fast? At Pablo e.U., we trade fairly and transparently.',
        items: [
          { title: 'Sales', description: 'Checked used cars (cars, commercial vehicles). Viewing in Sollenau (Industriestraße 1) anytime (by appointment).' },
          { title: 'Car Purchase (Cash)', description: 'We buy cars of all brands – even without inspection, with engine damage or accident vehicles. Fast processing and cash payment.' }
        ]
      },
      whyUs: {
        title: 'Why Pablo e.U. is your best partner in Sollenau',
        items: [
          { title: 'Availability', description: 'Real 24h emergency service – we always answer the phone, even on holidays.' },
          { title: 'Bilingual (DE/PL)', description: 'No misunderstandings during breakdowns. Ideal for international transporters on the A2.' },
          { title: 'All from one source', description: 'Towing, replacement car (rental) and purchase/sales.' }
        ]
      },
      faq: {
        ...
        items: [
          {
            ...
            answer: 'We prioritize emergencies in Sollenau and along the A2. Call us directly at +43 664 1261735 to confirm waiting time and location.'
          },
          {
            question: 'Do you buy cars with accident damage or engine failure?',
            answer: 'Yes, we value accident vehicles, high-mileage vehicles, or those without valid inspection, offering fair terms.'
          },
          {
            question: 'Can I pay the towing service by card on site?',
            answer: 'Yes, we accept cash as well as common debit and credit cards directly after the operation.'
          }
        ]
      },
      blog: {
        title: 'Latest Mobility Guides',
        subtitle: 'Tips, tricks, and news about cars, breakdowns, and road safety.',
        cta: 'Read all articles'
      }
    },
    towing: {
      title: '24/7 Towing Service Sollenau & Wiener Neustadt: Your Emergency Partner',
      intro:
      ...
      steps: [
        ...
        { title: '2. Location', description: 'Share your location via WhatsApp so we can find you quickly on the A2 or in nearby municipalities (Baden, Neunkirchen).' },
        { title: '3. Securing & Recovery', description: 'We secure the scene and transport your vehicle safely.' }
      ],
      servicesTitle: 'Our 24/7 service areas: more than just towing',
      services: [
        { title: 'Roadside assistance', description: 'Jump start (battery), tire change or temporary measures on site. We save you time and money.' },
        { title: 'Vehicle towing & recovery', description: 'Safe transport for cars, vans and accident vehicles to your destination of choice or our site.' },
        { title: 'Replacement car', description: 'We provide a replacement car (subject to availability) so you stay mobile.' }
      ],
      whyUs: {
        title: 'Why Pablo e.U. is the best choice in Lower Austria (EEAT)',
        items: [
          { title: '24/7 availability', description: 'We are reachable 365 days a year — including weekends and public holidays.' },
          { title: 'Bilingual support (DE/PL)', description: 'Full support in German and Polish, ideal for local customers and international drivers.' },
          { title: 'Flexible payment', description: 'Pay easily in cash or by card directly on site after the service.' },
          { title: 'Local expertise', description: 'Our location in Sollenau enables the fastest response times in Wiener Neustadt, Baden and Neunkirchen.' }
        ]
      },
      faq: {
        title: 'Frequently Asked Questions (FAQ)',
        items: [
          {
            ...
            answer: 'We prioritize emergency calls on the A2 and in the Wiener Neustadt area. We aim to reach you within the shortest possible time.'
          },
          {
            question: 'How much does towing cost at night or on public holidays?',
            answer: 'Costs depend on the time and distance. We focus on fair and transparent conditions. Call us for an immediate price indication.'
          },
          {
            question: 'Can I pay by credit card on site?',
            answer: 'Yes. For convenience, we accept cash as well as common debit and credit cards directly on site.'
          }
        ]
      },
    ...
    autohandel: {
      title: 'Certified Used Cars in Sollenau: Checked Quality Cheaper than in Vienna',
      intro:
      ...
      benefits: [
        { title: 'Fast Valuation', description: 'Direct assessment and offer for your vehicle – even with accident damage.' },
        { title: 'Fair Processing', description: 'Transparent terms, payout in cash or by card on site.' },
        { title: 'Pick-up Possible', description: 'We pick up your vehicle by arrangement – flexible in Wiener Neustadt-Land district.' },
        { title: 'Bilingual Advice', description: 'Advice in German or Polish, as desired.' }
      ],
    ...
    rental: {
      title: 'Rental Pablo e.U.: Car Rental & Real Estate Management in Baden & Vienna',
      intro:
      ...
      fleet: [
        { title: 'Cars', description: 'Various classes for daily needs – flexible depending on availability.' },
        { title: 'Light Commercial Vehicles', description: 'Transporters and vans ideal for moves, trades or short-term projects.' },
        { title: 'Trailers', description: 'Various models for transport tasks, available by arrangement.' }
      ],
      ...
      ctaDescription: 'Contact us for an availability inquiry and an individual rental offer for cars, transporters or replacement vehicles.',
      primary: 'Request Availability',
      secondary: '24/7 Emergency Call'
    },
    transport: {
      title: 'Transport & Moving Service: Reliable in Austria & Europe (Poland Line)',
      intro: 'Professional moves, machine transport and regular line traffic between Austria and Poland. We offer flat rates with no hidden costs.',
      servicesTitle: 'Our Transport Solutions',
      services: [
        { title: 'Moving Vienna & Lower Austria', description: 'Stress-free private moves at a fixed price – no floor surcharges.' },
        { title: 'Poland Line', description: 'Regular transport of furniture, packages and pallets (AT ↔ PL).' },
        { title: 'Machine Transport', description: 'Special transport for construction machinery and agricultural technology.' },
        { title: 'Logistics & Storage', description: 'Pallet shipping B2B and self-storage possibilities in Sollenau.' }
      ],
    ...
    about: {
      ...
      ctaDescription: 'We look forward to your inquiry – whether emergency call, car purchase or rental.',
      primary: 'Contact us',
      secondary: 'See vehicles'
    },
    contact: {
      title: 'Contact & directions – Autohandel & Abschleppdienst Pablo Sollenau',
      intro:
      ...
      description: 'Emergency call, purchase advice or selling your car – we are here for you. Support in German and Polish.',
      labels: {
      ...
      formDescription: 'Questions about a vehicle, selling or need towing? Send us a note!'
    },
    faq: {
      title: 'FAQ & advice',
      ...
      items: [
        {
          ...
          answer: 'We prioritise Sollenau, Wiener Neustadt and the A2. Call +43 664 1261735 to align arrival time.'
        },
        {
          question: 'Do you buy accident cars?',
          answer: 'Yes – high mileage, accident or without inspection. Fair valuation, cash or card payment.'
        },
        { question: 'Can I pay by card?', answer: 'Yes, cash and major cards after the service.' },
        { question: 'Do you provide replacement cars?', answer: 'If available we arrange replacements, often together with towing.' }
      ],
      blogTitle: 'Blog / advice (placeholder)',
      blog: [
        { title: 'How to secure an accident scene', description: 'Checklist for the first minutes after a breakdown on the A2 and nearby.' },
        { title: 'Selling damaged vehicles', description: 'When to sell an accident car? Tips for a fair valuation.' }
      ]
    },
    vehicles: {
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Rapid help on the A2 – on site within minutes and organised a replacement car.', author: 'Client from Wiener Neustadt' },
        { quote: 'Professional purchase of our van, fair valuation and instant payment.', author: 'Local service company' }
      ]
    },
    form: {
...
export function getJsonLdOrganization() {
  return {
    ...
    email: company.email,
    image: ['https://pablo-auto.at/abschleppdienst-24h-sollenau-a2-einsatz.webp', 'https://pablo-auto.at/opengraph-image.png'],
    address: {
      '@type': 'PostalAddress',
